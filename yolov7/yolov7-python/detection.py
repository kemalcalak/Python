...
if __name__ == '__main__':
    ...
    parser.add_argument("--source", type=str, default="test/videos/road.mp4", help="Video")
    parser.add_argument("--names", type=str, default="test/class.names", help="Object Names")
